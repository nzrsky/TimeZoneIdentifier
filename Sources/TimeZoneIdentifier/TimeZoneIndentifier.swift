...
extension TimeZone: TimeZoneConvertible {
    public func timezone() -> TimeZone { self }
}
...
extension TimeZoneIdentifier {
    public func timezone() -> TimeZone {
        ...
        case .autoUpdating: return .autoupdatingCurrent
        default: return TimeZone(id: self) ??
            { fatalError("Unknown time zone with name '\(rawValue)'") }()
        }
    }
}

// swiftlint:disable:next type_body_length
public enum TimeZoneIdentifier: String, TimeZoneConvertible {
